...
import { ErrorUtils } from '../../../shared/utils/index.js';
export class EnvironmentService {
     ...
     */
    async listEnvironments(request) {
        try {
     ...
     */
    async getEnvironmentDetails(request) {
        try {
     ...
     */
    async updateEnvironmentVariables(request) {
        try {
     ...
     */
    async duplicateEnvironment(sourceId, newName) {
        try {
     ...
     */
    async importEnvironment(name, data, projectId) {
        try {
