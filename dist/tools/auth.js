 ...
 */
export function createAuthToolHandlers() {
    return {
        [getProjectContextTool.name]: async (args) => {
            try {
                ...
                if (result.success && result.data) {
                    ...
                    let project, environments, folders, user;
...
export const TOOLS = AUTH_TOOLS;
export class ToolHandlers {
    static async handleGetProjectContext() {
