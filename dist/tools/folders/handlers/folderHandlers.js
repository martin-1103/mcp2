 ...
 */
function formatFolderTree(nodes, prefix = '') {
    let result = '';
 ...
 */
export async function handleListFolders(args) {
    try {
        ...
        const folderService = new FolderService(instances.backendClient.getBaseUrl(), instances.backendClient.getToken());
        // List folders
        const request = {
 ...
 */
export async function handleUpdateFolder(args) {
    try {
 ...
 * Move folder handler
 */
export async function handleMoveFolder(args) {
    try {
 ...
 */
export async function handleGetFolderDetails(args) {
    try {
        const { folderId } = args;
        if (!folderId) {
            return {
...
//# sourceMappingURL=folderHandlers.js.map