 ...
 */
import { listEndpointsTool, getEndpointDetailsTool, createEndpointTool, updateEndpointTool, deleteEndpointTool } from './tools.js';
 ...
 */
export function createEndpointToolHandlers() {
    return {
